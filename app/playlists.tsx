...
export const playlists: Playlist[] = [
		...
		handouts: [
			{
				...
				url:
					'https://mega.nz/file/U4Nh0K4R#dfsCxw2Hcuo8rR72aSI_vPM803GNPiu9HFaTO1XYU6w',
			},
			{
				name: 'Socioemotional Development Stages',
				url:
					'https://mega.nz/file/Jt9m1RqA#OqGevOV1kG2mZIYqfCOBbLEdRUNBtwvETvguMLKRHYo',
			},
		],
	},
	{
		...
		handouts: [
			{
				name: "Child's BBB",
				url:
					'https://mega.nz/file/w8MwmJ5b#Am_trZS_t5K-JyZ0SEwyfduznaW7oi6-LYJspXaCHKc',
			},
		],
	}, // week 6
	{
	...
	{ id: 'PLGXNehBPAYVZQhJ21ZYMF1LwJNcOMg8rp', name: 'Bonus' },
]
